...
$comandosql = "SELECT an1,an2,an3,an4,an5,an6,an7 FROM reports where grd_id=".$_SESSION['GRD'].";";
$resultado = $conn->query($comandosql);

if ($resultado->num_rows > 0) {
    echo ' <table   class="tablaA"><caption>Ultimos Datos Registrados</caption><tr bgcolor="#cebba6"><th>Nombre Medida</th><th>Dato medicion</th></tr>';
